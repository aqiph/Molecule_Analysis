...
class PAINS_Filter(object):
    ...
    def _get_pains_substructures(self):
        ...
        """
        print(os.getcwd())
        with open('/Users/guohan/Documents/Codes/Molecule_Analysis/utils/pains.txt') as fh_pains_substructure_SMARTS:
            pains_substructure_SMARTS = fh_pains_substructure_SMARTS.readlines()
            self.pains_substructure_list = [Chem.MolFromSmarts(smarts) for smarts in pains_substructure_SMARTS]
