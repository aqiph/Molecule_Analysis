...
def read_smiles(input_file, cleanup = True, plot2D = True, legend = None, cleanup_chirality = False):
    """
    read smiles from file
    :para input_file: str, file name
    :para cleanup: bool, whether or not to clean up smiles using chembl_structure_pipeline
    ...
    :return: str, smiles or cleaned smiles according to 'cleanup' and file name
    """  
    # file name
    ...
    if not smiles:
        print('Error: SMILES is not valid')
        return None
    try:
    ...
    # cleanup and canonicalize smiles
    if cleanup:
        smiles = cleanup_smiles(smiles, cleanup_chirality)
...
def cleanup_smiles(smiles, cleanup_chirality = False):
    """
    cleanup smiles using chembl_structure_pipeline
    :para smiles: the SMILES of the input molecule
    :para cleanup_chirality: bool, whether or not to remove chirality
    :return: cleaned smiles by chembl_structure_pipeline
    """
    smiles_cleanup, flag = preprocess_smiles(smiles, cleanup_chirality)
...
def preprocess_smiles(smiles, cleanup_chirality = False):
    """
    helper function for cleanup_smiles()
...
if __name__ == '__main__':
    ...
    smiles, name = read_smiles(input_file, cleanup = True, plot2D = True, legend = 'SMILES', cleanup_chirality = False)
