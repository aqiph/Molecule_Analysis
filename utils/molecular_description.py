...
from util import plot_2d_molecule_from_smiles
...
def cal_fingerprint_distance(fp_1, fp_2, fp_method = 'ecfp4'):
    ...
    :para fp_1: fingerprint, SMILES for molecule_1
    :para fp_2: fingerprint, SMILES for molecule_2
    :para fp_method: str, method to compute fingerprint
    :return: int or None
    """
...
if __name__ == '__main__':
    ...
    # for fp_method in ['topology', 'maccs', 'atompairs', 'torsions', 'ecfp4', 'fcfp4', 'mhfp6']:
